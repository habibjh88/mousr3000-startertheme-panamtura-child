            ...
            <header>
                <div class="post-meta-info">
                    ...
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><g
                                clip-path="url(#clip0_139_6)"><path
                                    ...
                                    fill="black"/></g><defs><clipPath id="clip0_139_6"><rect width="18" height="18"
...
$cta_content = get_post_meta( get_the_ID(), '_msr_child_custom_meta', true );
if ( $cta_content ) : ?>
    <div class="msr-single-cta">
		<?php if ( has_post_thumbnail() ) :
			the_post_thumbnail(
				'large',
				array(
					'class' => 'cta-overlay-image',
				)
			);
		endif;
		?>
        <div class="l-container--post">
			<?php echo wp_kses( $cta_content, $allowed_html ) ?>
        </div>
